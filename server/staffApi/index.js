...
app.post("/", (req, res) => {
    ...
    axios
        ...
        .catch((err) => {
            console.log("StaffApi calisan ekle");
...
app.put("/id/:id", (req, res) => {
    ...
    axios
        ...
        .catch((err) => {
            console.log("StaffApi calisan guncelle");
            console.log("Çalışan Güncellenirken bir hata meydana geldi");
            console.log(err);
...
app.delete("/id/:id", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("StaffApi calisan sil");
            console.log("Kişi silinirken hata meydana geldi");
            console.log(err);
...
app.get("/unvan", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("StaffApi unvan listele");
            console.log("Ünvanlar Listelenirken Bir Hata Meydana Geldi");
            console.log(err);
...
app.get("/birim/:birimadi/unvan/:unvanadi", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("StaffApi birim adı ve unvana gore calisan listele");
            console.log(`${req.params.birimadi} birimindeki ${req.params.unvanadi} grubu listelenemedi`);
            console.log(err);
            res
                .status(404)
                .send(
...
app.get("/doktor/:birimadi", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("StaffApi birim adına gore doktor listele");
            console.log(`${req.params.birimadi} birimindeki doktorlar listelenirken bir hata meydana geldi`);
            console.log(err);
            res
                .status(404)
                .send(
...
app.post("/oturumac", (req, res) => {
    ...
    axios
        ...
        .catch((err) => {
            console.log("StaffApi oturum açma");
            console.log("Oturum açılırken bir hata meydana geldi");
            console.log(err);
