...
router.get("/ameliyat/id/:id", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("employment ameliyat id ile");
            console.log(`${req.params.id} idli ameliyat listelenirken bir hata meydana geldi`);
            console.log(err);
            res
                .status(404)
                .send(
                    `${req.params.id} idli ameliyat listelenirken bir hata meydana geldi`
                );
        });
});
...
router.post("/ameliyat/", (req, res) => {
    ...
    axios
        ...
        .catch((err) => {
            console.log("employment ameliyat ekle");
...
router.get("/izin", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("employment izin listele");
...
router.get("/izin/id/:id", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("employment izin listele id ile");
...
router.delete("/izin/id/:id", (req, res) => {
    axios
        ...
        .catch((err) => {
            ...
            console.log('İzin iptal edilirken bir hatayla karşılaşıldı');
            console.log(err);
            res.status(400).send("İzin iptal edilirken bir hatayla karşılaşıldı");
        });
});
...
router.get("/nobet", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("employment nobet listele");
            console.log('Nöbetler listelenirken bir hata öeydana geldi');
            console.log(err);
...
router.get("/nobet/id/:id", (req, res) => {
    axios
        ...
        .then((result) => res.json(result.data))
        .catch((err) => {
            console.log("employment nobet listele id ile");
...
router.post("nobet/zaman", (req, res) => {
    ...
    axios
        ...
        .then((result) => res.json(result.data))
        .catch((err) => {
            console.log("employment nobet listele tarih secerek");
...
router.post("nobet/", (req, res) => {
    ...
    axios
        ...
        .catch((err) => {
            console.log("employment nobet olustur");
