...
router.get("/id/:id", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("Staff listele id ile");
            console.log("Kişi verilerine ulaşılamadı");
            console.log(err);
            res.status(404).send("Kişi verilerine ulaşılamadı");
        });
...
router.get("/unvan", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("Staff unvan listele");
...
router.get("/birim/:birimadi/unvan/:unvanadi", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("Staff birim adı ve unvana gore çalışan listele");
...
router.get("/doktor/:birimadi", (req, res) => {
    axios
        ...
        .catch((err) => {
            console.log("Staff birim adına gore doktor listele");
