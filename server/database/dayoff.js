...
router.get('/list', (req, res) => {
    let sql = `select cb.Ad,cb.Soyad,b.BirimAd,u.UnvanAdi,i.BaslangicTarih,i.BitisTarih,y.Ad as 'onaylayan ad',y.Soyad as 'onaylayan soyad' from ((((calisanbilgi cb join izinler i on i.KisiID=cb.CalisanID)
...
//function ıd bull
async function ekle(Ad, Soyad, BirimAd, UnvanAd, OnayAd, OnaySoyad, BaslaTarih, BitisTarih) {
...
router.post('/assigndayoff', async(req, res) => {
    ...
    console.log(await ekle(bil.Ad, bil.Soyad, bil.BirimAd, bil.UnvanAd, bil.OnayAd, bil.OnaySoyad, bil.BaslaTarih, bil.BitisTarih));
